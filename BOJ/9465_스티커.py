...
#
# [풀이]
# 3칸 뒤 대각선은 1칸 뒤 대각선 3번으로 움직일 수 있으므로 주어진 조건을 만족하면서 움직이는 경우는
# 1칸 뒤 대각선, 2칸 뒤 대각선으로 움직이는 경우 밖에 없다.
#
# 따라서 dp 테이블을 갱신할 때 1칸 뒤 대각선과 2칸 뒤 대각선의 크기를 비교하여 갱신하고 최종적으로 dp[0~1][n]의 최대값을 출력한다.
...
for _ in range(T):
    ...
    dp[0][0] = sticker_list[0][0]
    dp[1][0] = sticker_list[1][0]
    dp[0][1] = dp[1][0] + sticker_list[0][1]
    dp[1][1] = dp[0][0] + sticker_list[1][1]
